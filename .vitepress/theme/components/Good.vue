...
<template>
  <div flex rounded-lg p="x-4 y-6" dark:bg-neutral-800 dark:shadow-none
    ...
    <div class="bg-white dark:bg-neutral-800 p-2 shrink-0">
      <img :src="frontmatter.image" alt="good-image" :width="imageWitdh" :height="imageWitdh" />
    </div>
    <div class="ml-4 grow">
      <div class="text-lg font-bold">
        <o-tag type="error" v-if="props.isRecommend">推荐</o-tag>{{ props.title || `商品标题` }}
      </div>
      <div
      ...
      <div class="mt-4 flex items-center">
        <o-button class="shrink-0" type="secondary" @click="clickBuy">立即购买</o-button>
        <div class="grow"></div>
